...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.60, -- Basic efficiency for taxes without 'crats and tech
	...
	GREATNESS_DAYS = 1826, 	   -- how many days until country risks losing status as great nation
	BADBOY_LIMIT = 25,
	...
	COLONY_FORMED_PRESTIGE = 10, -- prestige from founding a colony.
	...
	MOBILIZATION_SPEED_RAILS_MULT = 1.0, -- Speed modifier for raising troops. It's max value for max railways level in state.
...
economy = {
	...
	SECOND_RANK_BASE_SHARE_FACTOR = 1.0,
	CIV_BASE_SHARE_FACTOR = 1.0,
	UNCIV_BASE_SHARE_FACTOR = 1.0,
	FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.95, -- % of how much we pay to the pops and capitalists, from the leftovers.
	MAX_FACTORY_MONEY_SAVE = 50,	-- how much money is stored maximum in a factory.
...
military = {
	...
	LEADER_PRESTIGE_TO_MAX_ORG_FACTOR = 0.35, -- f.ex. 100% of prestige = +10 max org
	...
	LEADER_PRESTIGE_LAND_GAIN =1.5, -- extra speed gain on prestige for land combat
	LEADER_PRESTIGE_NAVAL_GAIN =1.5, -- extra speed gain on prestige for naval combat
	...
	BASE_MILITARY_TACTICS = 4.0, -- base mil tactics before tech
...
pops = {
	...
	CON_POOR_CLERGY = 0.0,
	CON_MIDRICH_CLERGY = 0.0,
	CON_REFORM_IMPACT = -50,
	CON_COLONIAL_FACTOR = 0.5,
	RULING_PARTY_HAPPY_CHANGE = -1,
	RULING_PARTY_ANGRY_CHANGE = 4,

	PDEF_BASE_CON = 100000.0,			-- so half'ed effect.
...
ai =
{
	...
	MONTHS_BEFORE_DISBAND = 7, -- Months from start date before AI will disband armies/navies (to avoid disbands because of early economic turmoil)
},
